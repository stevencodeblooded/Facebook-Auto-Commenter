// Authentication module for Facebook Auto Commenter

// Define auth manager
const authManager = {
  // Default fallback password in case remote check fails
  defaultPassword: "autocommenter2024",

  // Remote password source (GitHub raw file URL)
  remotePasswordUrl:
    "https://raw.githubusercontent.com/stevencodeblooded/password-repo/main/password.txt",
  ...
  async getCurrentPassword() {
    try {
      ...
      console.log("Error getting remote password, using default");
    }
...
// Export the authManager as the default export
export default authManager;

// Check for browser environment before adding event listeners
